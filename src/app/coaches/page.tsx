...
export const metadata: Metadata = {
  title: "Coaches",
  description:
    "Meet the USFA-certified coaches of the Des Moines Fencing Club, teaching foil, épée, and saber in central Iowa.",
};
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-5">
            ...
            <h1 className="mt-6 text-[clamp(48px,7vw,96px)] leading-[1.0]">
              <span className="italic">USFA</span>‑certified.
              <br />
              Every weapon.
            </h1>
          </div>
          <div className="col-span-12 md:col-span-6 md:col-start-7 self-end">
            <p className="text-lg leading-relaxed text-ink">
              Our typical 60-minute classes are led by USFA-certified coaches and built around warm-ups,
